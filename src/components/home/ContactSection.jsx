...
export default function ContactSection({ image }) {
  ...
  const submit = (e) => {
    ...
    window.location.href = `mailto:hello@southernaccentcabinetry.com?subject=Consultation Request&body=${body}`;
  };
  return (
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr]">
          <div className="space-y-6 text-white/82">
            <p className="flex gap-4"><MapPin className="h-5 w-5 text-[#C8A977]" />75 Pineview Ave, North Augusta, SC 29841, United States</p>
            <p className="flex gap-4"><Phone className="h-5 w-5 text-[#C8A977]" /><span><a href="tel:+18034423868">+1 803-442-3868</a></span></p>
            <p className="flex gap-4"><Mail className="h-5 w-5 text-[#C8A977]" /><a href="mailto:hello@southernaccentcabinetry.com">hello@southernaccentcabinetry.com</a></p>
            <p className="flex gap-4"><Clock className="h-5 w-5 text-[#C8A977]" />Monday–Friday, 8:00 AM – 4:00 PM</p>
            <iframe title="Southern Accent Cabinetry map" className="h-72 w-full border-0 grayscale" loading="lazy" src="https://www.google.com/maps?q=75%20Pineview%20Ave%2C%20North%20Augusta%2C%20SC%2029841%2C%20United%20States&output=embed" />
          </div>
