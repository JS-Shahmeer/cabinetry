          ...
          {products.map((product) => (
            <SwiperSlide key={product.title}>
              <a
                ...
                className="group block h-full bg-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#8C6A43] focus-visible:ring-offset-2"
              >
                <article className="h-full">
                  ...
                  <div className="p-6 min-h-[330px]">
                    ...
                    <div className="mt-6 inline-flex items-center gap-2 text-sm text-[#8C6A43] transition-colors group-hover:text-primary">
