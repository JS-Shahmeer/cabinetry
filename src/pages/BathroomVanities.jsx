...
const faqs = [
  ["Can you match my existing bathroom style?", "Yes. We build custom vanities in any door style, wood species, and finish to complement your existing tile, fixtures, and flooring."],
  ["Do you build vanities for small bathrooms?", "Absolutely. Custom vanities are especially valuable in small bathrooms because they can be sized to maximize every available inch rather than leaving gaps."],
  ["What countertop options work with custom vanities?", "We build the cabinet base only; your countertop professional or tile installer applies the surface. We coordinate dimensions precisely to accommodate your chosen material."],
  ["How long does a custom bathroom vanity take?", "Typically 3–5 weeks from approved design to installation for a standard vanity project."],
];
...
export default function BathroomVanities() {
  return (
    <PageLayout title="Bathroom Vanities & Cabinetry" description="Custom bathroom vanities and cabinetry built with all-wood construction in North Augusta, SC and Augusta, GA. Freestanding, floating, built-in, and double-sink designs.">
      <PageHero
        eyebrow="Custom Bathroom Vanities · North Augusta, SC"
        title="Custom Bathroom Vanities Built to Last"
        subtitle="All-wood vanity cabinets designed for your bathroom's exact dimensions, storage needs, and aesthetic—not pulled from a showroom catalog."
        image={IMG.bath}
      />
      <TrustBar />
      ...
      <section className="px-5 py-24 lg:px-8 lg:py-32">
        <div className="mx-auto grid max-w-7xl items-center gap-14 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-6 text-lg leading-8 text-muted-foreground">Standard vanity sizes rarely fit bathrooms perfectly. Custom vanity cabinetry eliminates the gap between cabinet and wall, maximizes storage in odd-shaped spaces, and creates a cohesive, finished look that stock cabinets can't achieve.</p>
            <p className="mt-4 text-lg leading-8 text-muted-foreground">Whether you're remodeling a master bath or updating a powder room, Southern Accent Cabinetry designs and builds custom bath cabinetry that elevates the entire room.</p>
      ...
      <section className="bg-white px-5 py-24 lg:px-8 lg:py-32">
        <div className="mx-auto max-w-7xl">
          <div className="mb-14 max-w-3xl">
            <p className="mb-4 text-xs uppercase tracking-[0.32em] text-[#8C6A43]">Vanity designs</p>
            <h2 className="font-display text-4xl leading-tight text-primary md:text-5xl">Custom Vanity Styles for Every Bathroom</h2>
          </div>
      ...
      <section className="bg-primary px-5 py-24 text-white lg:px-8 lg:py-32">
        <div className="mx-auto grid max-w-7xl items-center gap-14 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-5 text-lg leading-8 text-white/72">Custom cabinetry unlocks storage in spaces that stock furniture ignores: the space under a sloped ceiling, a narrow alcove between the toilet and wall, or a full-height cabinet in an unused corner.</p>
            <div className="mt-8 space-y-3">
      ...
      <section className="bg-white px-5 py-24 lg:px-8 lg:py-32">
        <div className="mx-auto max-w-4xl">
          ...
          <h2 className="mb-12 font-display text-4xl leading-tight text-primary md:text-5xl">Bathroom Vanity Questions</h2>
      ...
      <ConsultationCTA headline="Ready to Design Your Custom Bathroom Vanity?" sub="Tell us about your bathroom. We'll help you explore layout options, styles, and materials for a vanity built perfectly for your space." />
    </PageLayout>
  );
}